...
public class MethodsDemo {
		...
		//Method is a block of code a group of java statements that are grouped together and we can
		//execute those statements by just creating an object of the class that contains
